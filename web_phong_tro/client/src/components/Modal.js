...
import { getNumbersPrice, getNumbersArea } from '../utils/Common/getNumbers.js'
...
const Modal = ({ setIsShowModal, content, name, handleSubmit, queries, arrMinMax, defaultText }) => {
    ...
    useEffect(() => {
        ...
        //lấy độ dài khoảng cách của 2 nút trong input range
    }, [persent1, persent2])

    const handleClickTrack = (e, value) => {
        const stackEl = document.getElementById('track')
        const stackRect = stackEl.getBoundingClientRect() //lấy kích thước trái phải trên dưới của stackEl
            ...
            >
                <div className='h-[45px] px-4 flex items-center border-b border-gray-200'>
                    <span className='cursor-pointer' onClick={(e) => {
                        e.stopPropagation() // chặn khi nhấn vào popup không ẩn đi
